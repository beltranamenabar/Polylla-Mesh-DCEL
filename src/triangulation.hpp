...
public:
    ...
    int face_index(int i) { return HalfEdges.at(i).face; }
    ...
    int faces() { return n_faces; }

    //Return number of halfedges
    int halfEdges() { return n_halfedges; }

    //Return number of vertices
    int vertices() { return n_vertices; }
    ...
    std::vector<int> get_Triangles() { return triangle_list; }

    double get_PointX(int i) { return Vertices.at(i).x; }

    double get_PointY(int i) { return Vertices.at(i).y; }

    //Calculates the next edge of the face incident to edge e
    //Input: e is the edge
    //Output: the next edge of the face incident to e
    int next(int e) { return HalfEdges.at(e).next; }

    //Calculates the tail vertex of the edge e
    //Input: e is the edge
    //Output: the tail vertex v of the edge e
    int origin(int e) { return HalfEdges.at(e).origin; }


    //Calculates the head vertex of the edge e
    //Input: e is the edge
    //Output: the head vertex v of the edge e
    int target(int e) { return HalfEdges.at(e).target; }

    //Return the twin edge of the edge e
    //Input: e is the edge
    //Output: the twin edge of e
    int twin(int e) { return HalfEdges.at(e).twin; }

    //Return the twin edge of the edge e
    //Input: e is the edge
    //Output: the twin edge of e
    int prev(int e) { return HalfEdges.at(e).prev; }
    ...
    int edge_of_vertex(int v) { return Vertices.at(v).incident_halfedge; }

    //Input: edge e
    //Output: true if is the face of e is border face
    //        false otherwise
    bool is_border_face(int e) { return HalfEdges.at(e).is_border; }

    // Input: edge e of compressTriangulation
    // Output: true if the edge is an interior face a
    //         false otherwise
    bool is_interior_face(int e) { return !this->is_border_face(e); }

    //Input:vertex v
    //Output: the edge incident to v, wiht v as origin
    bool is_border_vertex(int v) { return Vertices.at(v).is_border; }
};
